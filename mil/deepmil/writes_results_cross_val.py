...
def main(raw_args=None):
    ...
    parser.add_argument(
        "--path", type=str, help="folder where are stored the models.", default="."
    )
    parser.add_argument(
        "--n_ensemble",
        type=int,
        default=1,
        help="number of models to select for testing (ensembling if > 1). better to choose odd number",
    )
